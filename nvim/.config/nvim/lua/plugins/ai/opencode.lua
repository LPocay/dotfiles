return {
  ...
  keys = {
    ...
    { "<leader>or", function() return require("opencode").operator("@this ") end, mode = { "n", "x" }, desc = "Add range to opencode", expr = true },
  ...
  config = function()
    ...
    -- Keep AI actions behind an explicit leader namespace.
